...
<div class="task-form">
    ...
    <?= $form->field($model, 'link_lecture')->textInput(['maxlength' => true, 'placeholder' => 'Link Lecture']) ?>

    <?= $form->field($model, 'file')->textInput(['maxlength' => true, 'placeholder' => 'File']) ?>

    <?= $form->field($model, 'status')->dropDownList([ 'new' => 'New', 'in progress' => 'In progress', 'done' => 'Done', ], ['prompt' => '']) ?>
